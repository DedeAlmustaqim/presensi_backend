...
<div class="card-inner">
    ...
    <h6 class="mt-2">Perhitungan Kredit Skor berdasarkan Peraturan Bupati Barito Timur No 8 Tahun 2024</h6>
    <div class="row-12">
        <table class="table table-bordered table-striped">
            <thead class="table-dark">
                <tr class="text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php if ($thck1_rekap  != number_format($countCutiBesar->total_subtraction ?? 0, 2, '.', '')) {
                            echo "<p class='text-danger'>Tidak Sesuai</p>";
                        } else {
                            echo "<p class='text-primary'>Sesuai</p>";
                        } ?></td>
                ...
                <tr>
                    ...
                    <td><?php if ($thck2_rekap  != number_format($countCutiSakit->total_subtraction ?? 0, 2, '.', '')) {
                            echo "<p class='text-danger'>Tidak Sesuai</p>";
                        } else {
                            echo "<p class='text-primary'>Sesuai</p>";
                        } ?></td>
                ...
                <tr>
                    ...
                    <td><?php if ($thck3_rekap  != number_format($countCutiTahunan->total_subtraction ?? 0, 2, '.', '')) {
                            echo "<p class='text-danger'>Tidak Sesuai</p>";
                        } else {
                            echo "<p class='text-primary'>Sesuai</p>";
                        } ?></td>
    ...
    <form id="postTpp" method="POST">
        ...
        <input hidden type="text" name="ijm" id="ijm" value="<?php echo $IZIN_IN * 0.5 ?>">
        <input hidden type="text" name="ijp" id="ijp" value="<?php echo $IZIN_OUT * 0.5 ?>">
        <input hidden type="text" name="thck1" id="thck1" value="<?= $countCutiBesar->total_subtraction ?? 0 ?>">
        <input hidden type="text" name="thck2" id="thck2" value="<?php echo $countCutiSakit->total_subtraction ?? 0 ?>">
        <input hidden type="text" name="thck3" id="thck3" value="<?php echo $countCutiTahunan->total_subtraction ?? 0 ?>">
