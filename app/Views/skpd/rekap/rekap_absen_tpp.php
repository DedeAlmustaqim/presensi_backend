                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php if ($thck1_rekap  != $countCutiBesar->jumlah_baris) {
                                    echo "<p class='text-danger'>Tidak Sesuai</p>";
                                } else {
                                    echo "<p class='text-primary'>Sesuai</p>";
                                } ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php if ($thck2_rekap  != $countCutiSakit->jumlah_baris) {
                                    echo "<p class='text-danger'>Tidak Sesuai</p>";
                                } else {
                                    echo "<p class='text-primary'>Sesuai</p>";
                                } ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php if ($thck3_rekap  != $countCutiTahunan->total_subtraction) {
                                    echo "<p class='text-danger'>Tidak Sesuai</p>";
                                } else {
                                    echo "<p class='text-primary'>Sesuai</p>";
                                } ?></td>
